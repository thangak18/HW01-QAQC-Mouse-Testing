# HW01 Submission Checklist

## Files created in this HW1 folder
...
- [x] AI_03_Disclosure_Form.md
- [x] AI_05_Privacy_Checklist.md
- [x] GITHUB_REPO_AND_ISSUES.md

## Evidence still required from student
- [x] Save 10 job-posting screenshots in evidence/job_screenshots.
- [ ] Re-check 10 job screenshots: current images show logged-in avatar/account state, but many do not show the written username. Re-capture with profile/account menu open if the TA requires visible username text.
- [x] Take 1 photo of the physical device and student ID card in the same frame.
- [x] Paste at least 5 execution video links for TC01-TC05.
