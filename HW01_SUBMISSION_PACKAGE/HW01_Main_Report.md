...
| GitHub repo link và Issues cho defect thiết bị | Repo link đã chuẩn bị | Repo: https://github.com/thangak18/HW01-QAQC-Mouse-Testing. Cần tạo Issues nếu có defect thật và chụp screenshot trang Issues có username. |
...
Bằng chứng ảnh: Đính kèm screenshot có ngày đăng và tài khoản LinkedIn của tôi.

![Job 01 screenshot - LinkedIn Suli](evidence/job_screenshots/job_01_linkedin_suli.png)
...
![Job 02 screenshot - LinkedIn Meridial](evidence/job_screenshots/job_02_linkedin_meridial.png)
...
![Job 03 screenshot - LinkedIn TEKsystems](evidence/job_screenshots/job_03_linkedin_teksystems.png)
...
Bằng chứng ảnh: Đính kèm screenshot có trạng thái New và tài khoản TopCV của tôi.

![Job 04 screenshot - TopCV Salaman](evidence/job_screenshots/job_04_topcv_salaman.png)
...
![Job 05 screenshot - TopCV Techvify](evidence/job_screenshots/job_05_topcv_techvify.png)
...
Bằng chứng ảnh: Đính kèm screenshot có hạn nộp và tài khoản TopCV của tôi.

![Job 06 screenshot - TopCV Fetek](evidence/job_screenshots/job_06_topcv_fetek.png)
...
![Job 07 screenshot - TopCV ITSOL](evidence/job_screenshots/job_07_topcv_itsol.png)
...
Bằng chứng ảnh: Đính kèm screenshot có ngày đăng và tài khoản ITviec của tôi.

![Job 08 screenshot - ITviec Ewoosoft](evidence/job_screenshots/job_08_itviec_ewoosoft.png)
...
![Job 09 screenshot - ITviec MoMo](evidence/job_screenshots/job_09_itviec_momo.png)
...
![Job 10 screenshot - ITviec Netcompany](evidence/job_screenshots/job_10_itviec_netcompany.png)
...
Thiết bị cụ thể: Chuột máy tính có dây hoặc không dây.
...
Loại kết nối: USB receiver

Serial number: 0007

Bằng chứng ảnh thiết bị + thẻ sinh viên:

![Ảnh chuột và thẻ sinh viên](evidence/device_photo_student_id/z7895388996384_b44c471ac814787a086e127c32784dbc.jpg)
...
- Expected result là hệ thống phản hồi đúng khi tôi click trái vào folder này.
- Tôi sẽ click trái vào folder.
...
Ghi chú: Đây là template để log defect thật. Nếu trong quá trình test không phát hiện defect, giữ link issue trống và ghi rõ không tìm thấy defect ở các test case đã thực thi.
...
![AI-generated mouse test cases screenshot](evidence/ai_screenshots/A3_mouse_test_cases_ai_output.png)
...
| Nộp 1 ảnh thiết bị + thẻ sinh viên cùng khung hình | Đã có ảnh | Ảnh nằm trong `evidence/device_photo_student_id`. |
...
Một số phần của report, bao gồm cấu trúc requirement, bản nháp test cases, bảng defect/source link, checklist nộp bài và cách tổ chức nội dung ban đầu, được tạo hoặc hỗ trợ ban đầu bởi OpenAI Codex/ChatGPT. Tôi đã review và chỉnh sửa các phần tương ứng trong Requirement 1, Requirement 2, Requirement 3 và AI Collaboration Protocol; tôi bổ sung edge cases TC09, TC10, TC11, TC12, TC13 và TC14; tôi kiểm tra lại các link nguồn defect; tôi thay bằng chứng placeholder bằng screenshot việc làm, ảnh thiết bị và link video thật khi có. Phần test execution/video, ảnh thiết bị kèm thẻ sinh viên, screenshot job thật, prompt timestamp thật và các nhận xét/correction cuối cùng được kiểm chứng hoặc thực hiện bởi tôi. AI Audit Report chi tiết được đính kèm trong `AI_02_Audit_Report.md`. Tôi xác nhận không dùng AI để tạo bất kỳ artifact nào thuộc nhóm bị cấm, bao gồm ảnh thiết bị với thẻ sinh viên, video thực thi bằng giọng nói/thiết bị thật, screenshot job có tài khoản của tôi hoặc timestamp prompt log thật.
...
| --- | --- | --- |
| Ảnh thiết bị kèm thẻ sinh viên trong cùng khung hình | `evidence/device_photo_student_id/z7895388996384_b44c471ac814787a086e127c32784dbc.jpg` | Đã có ảnh thật trong package; cần bảo đảm thông tin trên thẻ đủ rõ khi nộp. |
...
| --- | --- | --- |
| Thị trường việc làm QA/QC 2026+ (10 jobs x 3 pts + AI Impact) | 40 | [Điền] |
| 20 lỗi phần mềm giai đoạn 2022-2026 | 20 | [Điền] |
| Thiết kế test sản phẩm vật lý (15 TCs + 5 videos) | 25 | [Điền] |
| AI-02 Audit Report đính kèm | 8 | [Điền] |
| Phê bình AI + AI-03 Disclosure đính kèm | 4 | [Điền] |
| AI-05 Checklist + anti-cheat artifacts | 3 | [Điền] |
| Tổng | 100 | [Điền] |
