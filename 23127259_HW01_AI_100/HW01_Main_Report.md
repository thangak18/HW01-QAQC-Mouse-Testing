...
Ghi chú: Không nộp bằng chứng giả; các ảnh, video và link phải là bằng chứng thật của bài làm.
...
Thương hiệu: OEM/Generic USB Mouse.

Model: Generic Optical USB Mouse.

Năm sử dụng/test: 2026

Loại kết nối: USB dây.

Serial number: MOU6-****-26A9. Đây là mã nhận diện kiểm thử nội bộ được gán cho thiết bị vì không thấy serial nhà sản xuất trên ảnh/thiết bị; 4 ký tự giữa đã được mask theo yêu cầu.
...
| Khai báo brand, model, year, serial number | Đã điền | Dùng thông tin chuột USB generic; serial là mã nhận diện kiểm thử nội bộ đã mask vì không thấy serial nhà sản xuất trên thiết bị. |
