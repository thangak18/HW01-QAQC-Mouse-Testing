...
```text
Đây là cấu trúc thư mục nộp bài của em: 23127259_HW01_AI_100.zip với HW01_Main_Report.pdf/md, checklist xlsx, prompt log, mindmap, AI_02, AI_03, AI_05, GitHub repo/issue file, video links txt, device photo, GitHub issues screenshot và evidence/job_screenshots, evidence/ai_screenshots. Bạn sửa lại, file nào thừa thì xoá rồi đổi tên cho đúng, chưa cần zip liền nhé.
```
